...
if beautiful.wallpaper then
    for s = 1, screen.count() do
        if s % 2 == 1 then
            ...
            gears.wallpaper.maximized(beautiful.wallpaper_alt, s, true)
        end
    end
end
-- }}}
...
for s = 1, screen.count() do
    ...
    if s % 2 == 1 then
        tags[s] = awful.tag(
            { "terminal", "pycharm", "other", "media" },
            s,
            { layouts[2], layouts[2], layouts[2], layouts[2] })
    else
        tags[s] = awful.tag(
            { "terminal2", "internet", "editor", "chat", "bricks" },
            s,
            { layouts[2], layouts[2], layouts[2], layouts[2], layouts[1] })
    end
end
-- }}}
