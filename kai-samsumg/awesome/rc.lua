...
beautiful.init("/home/kai/.config/awesome/themes/default/theme.lua")
...
-- My Launchers
kate_button = awful.widget.button({ image = beautiful.kate_icon })
kate_button:buttons(awful.util.table.join(
    awful.button({ }, 1, function() awful.util.spawn("kate") end)
))
...
heroes3_button = awful.widget.button({ image = beautiful.heroes3_icon })
...
for s = 1, screen.count() do
    ...
    left_layout:add(separator)
    left_layout:add(vlc_button)
    left_layout:add(separator)
    left_layout:add(heroes3_button)
    left_layout:add(separator)
